...
public class FormTablesRectangle extends javax.swing.JPanel {

    public FormTablesRectangle() {
        initComponents();
        embedRectangulatopTablePanel();
    }

    private void embedRectangulatopTablePanel() {
        RectangulatopTable rectangulatopTablePanel = new RectangulatopTable();
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(rectangulatopTablePanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap())
        );
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(rectangulatopTablePanel, GroupLayout.DEFAULT_SIZE, 448, Short.MAX_VALUE)
                                .addContainerGap())
        );
    }
    ...
    private void initComponents() {
        ...
        lb.setText("Rectangular Top Tables");
