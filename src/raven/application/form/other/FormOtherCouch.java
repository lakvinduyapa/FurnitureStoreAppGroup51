...
public class FormOtherCouch extends javax.swing.JPanel {

    public FormOtherCouch() {
        initComponents();
        embedCouchPanel();
    }

    private void embedCouchPanel() {
        Couch couchPanel = new Couch();
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(couchPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap())
        );
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(couchPanel, GroupLayout.DEFAULT_SIZE, 448, Short.MAX_VALUE)
                                .addContainerGap())
        );
    }
