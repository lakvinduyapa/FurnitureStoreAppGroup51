...
public class FormOtherBookshelf extends javax.swing.JPanel {

    public FormOtherBookshelf() {
        initComponents();
        embedBookshelfPanel();
    }

    private void embedBookshelfPanel() {
        Bookshelf bookshelfPanel = new Bookshelf();
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(bookshelfPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap())
        );
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(bookshelfPanel, GroupLayout.DEFAULT_SIZE, 448, Short.MAX_VALUE)
                                .addContainerGap())
        );
    }
