...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
            ...
            {"Home"},
            {"~CATEGORIES~"},
            {"Chairs", "Standard","Armchair"},
            {"Tables", "Office Desk","Round Top", "Rectangular Top"},
            {"Beds", "Double Bed","Single Bed"},
            {"Other", "Stool","Bar Stool","Couch", "Cabinet", "Bookshelf"},
//        {"Tables"},
//        {"Other"},
//        {"~COMPONENT~"},
...
//        {"Special Pages", "Blank page", "Faq", "Invoice", "Profile", "Pricing", "Timeline"},
    ...
    private final String headerName = "   Furniture Store";
